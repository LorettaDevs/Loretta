...
namespace Loretta.CodeAnalysis.Lua
{
    ...
    public enum SyntaxKind : ushort
    {
        ...
        /// <summary>Represents an interpolated string token.</summary>
        [Token, ExtraCategories(SyntaxKindCategory.LiteralToken),
        ...
        // Big gap 1006-2000 (insert new tokens with text here)
        ...
        InterpolatedStringExpression = 2115,
