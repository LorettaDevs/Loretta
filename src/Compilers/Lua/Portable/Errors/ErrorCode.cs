namespace Loretta.CodeAnalysis.Lua
{
    internal enum ErrorCode
    {
        ...
        ERR_InterpolatedStringMustStartWithBacktickCharacter = 33,
        ERR_UnclosedExpressionHole                           = 34,
        ERR_DoubleBraceInInterpolation                       = 35,
        ERR_InterpolatedStringsNotSupportedInVersion         = 36,
