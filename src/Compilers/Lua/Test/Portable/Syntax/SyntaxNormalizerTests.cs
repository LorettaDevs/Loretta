...
public sealed partial class SyntaxNormalizerTests : LuaTestBase
{
    ...
    private sealed partial class InterpolatedInlineData(string inputTemplate, string expectedTemplate) : DataAttribute
    {
            ...
            while (inputEnumerator.MoveNext())
            {
                if (!expectedEnumerator.MoveNext())
                {
                    throw new InvalidOperationException(
                        $"Unbalanced templates: {inputTemplate} |=| {expectedTemplate}");
                }

                rows.Add(inputEnumerator.Current, expectedEnumerator.Current);
            }
