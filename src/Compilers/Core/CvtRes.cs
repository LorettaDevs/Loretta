...
namespace Loretta.CodeAnalysis
{
    ...
    internal static class COFFResourceReader
    {
        ...
        internal static Loretta.Cci.ResourceSection ReadWin32ResourcesFromCOFF(Stream stream)
        {
    ...
    internal static class Win32ResourceConversions
    {
         ...
         * Dev10 alink had the following fallback behavior.
                private uint[] FileVersion
                {
                    get
                    {
                        ...
                        {
                            Loretta.Utilities.RoslynDebug.Assert(assemblyVersionContents != null);
            ...
            string? companyName = null)
        {
            ...
            Loretta.Utilities.RoslynDebug.Assert(resStream.Position - startPos == dataSize + headerSize);
        }
        ...
        private class VersionResourceSerializer
        {
            ...
            private static void WriteVersionString(KeyValuePair<string, string> keyValuePair, BinaryWriter writer)
            {
                ...
                RoslynDebug.Assert((startPos & 3) == 0);
                ...
                RoslynDebug.Assert((writer.BaseStream.Position & 3) == 0);
                writer.Write(keyValuePair.Value.ToCharArray());
                writer.Write((WORD)'\0');
                //writer.Write(new byte[PadToDword(cbVal) - cbVal]);

                Loretta.Utilities.RoslynDebug.Assert(cbBlock == writer.BaseStream.Position - startPos);
            }
            ...
            internal void WriteVerResource(BinaryWriter writer)
            {
                ...
                */
                ...
                Loretta.Utilities.RoslynDebug.Assert((writer.BaseStream.Position & 3) == 0);
                ...
                Loretta.Utilities.RoslynDebug.Assert(writer.BaseStream.Position - debugPos == dataSize - GetStringsSize());
                ...
                foreach (var entry in GetVerStrings())
                {
                    ...
                    Loretta.Utilities.RoslynDebug.Assert(entry.Value != null);
                    WriteVersionString(entry, writer);
                }

                Loretta.Utilities.RoslynDebug.Assert(writer.BaseStream.Position - debugPos == GetStringsSize());
            }
        }
    }
}
