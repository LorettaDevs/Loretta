...
namespace Loretta.Cci
{
    ...
    internal abstract class MetadataVisitor
    {
        ...
        public virtual void Visit(IFieldDefinition fieldDefinition)
        {
            ...
            RoslynDebug.Assert((constant != null) == fieldDefinition.IsCompileTimeConstant);
            RoslynDebug.Assert((marshalling != null || !fieldDefinition.MarshallingDescriptor.IsDefaultOrEmpty) == fieldDefinition.IsMarshalledExplicitly);
        ...
        public virtual void Visit(IParameterDefinition parameterDefinition)
        {
            ...
            RoslynDebug.Assert((marshalling != null || !parameterDefinition.MarshallingDescriptor.IsDefaultOrEmpty) == parameterDefinition.IsMarshalledExplicitly);
