...
using static Loretta.CodeAnalysis.SigningUtilities;
using EmitContext = Loretta.CodeAnalysis.Emit.EmitContext;
...
namespace Loretta.Cci
{
    ...
    internal static class PeWriter
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            RoslynDebug.Assert(nativePdbWriterOpt == null || pdbPathOpt != null);
            ...
            RoslynDebug.Assert(properties.PersistentIdentifier == default(Guid));
            ...
            if (mdWriter.EmitPortableDebugMetadata)
            {
                ...
                RoslynDebug.Assert(!isDeterministic || context.Module.PdbChecksumAlgorithm.Name != null);
        ...
        private static void PatchModuleVersionIds(Blob guidFixup, Blob guidSectionFixup, Blob stringFixup, Guid mvid)
        {
            if (!guidFixup.IsDefault)
            {
                ...
                RoslynDebug.Assert(writer.RemainingBytes == 0);
            }
        ...
        private class ResourceSectionBuilderFromObj : ResourceSectionBuilder
        {
            ...
            {
                RoslynDebug.Assert(resourceSection != null);
        ...
        private class ResourceSectionBuilderFromResources : ResourceSectionBuilder
        {
            ...
            {
                RoslynDebug.Assert(resources.Any());
