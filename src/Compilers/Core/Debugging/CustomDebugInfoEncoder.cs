...
namespace Loretta.CodeAnalysis.Debugging
{
    internal struct CustomDebugInfoEncoder
    {
        ...
        public byte[] ToArray()
        {
            ...
            RoslynDebug.Assert(_recordCount <= byte.MaxValue);
        ...
        {
            RoslynDebug.Assert(groupSizes.Count <= ushort.MaxValue);
            ...
            AddRecord(
                ...
                (uc, builder) =>
                {
                    ...
                    {
                        RoslynDebug.Assert(usingCount <= ushort.MaxValue);
        ...
        {
            RoslynDebug.Assert(dynamicLocals != null);
            ...
            AddRecord(
                ...
                (infos, builder) =>
                {
                    ...
                    {
                        RoslynDebug.Assert(info.Flags.Length <= DynamicAttributeSize);
                        RoslynDebug.Assert(info.LocalName.Length <= IdentifierSize);
        ...
        {
            RoslynDebug.Assert(tupleLocals != null);
            ...
            AddRecord(
                ...
                (infos, builder) =>
                {
                    RoslynDebug.Assert(infos.Count > 0);
                    ...
                    foreach (var info in infos)
                    {
                        ...
                        RoslynDebug.Assert((info.SlotIndex == -1) ^ (info.ScopeStart == 0 && info.ScopeEnd == 0));
