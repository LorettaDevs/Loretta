...
namespace Loretta.CodeAnalysis
{
    ...
    internal abstract class SarifErrorLogger : ErrorLogger, IDisposable
    {
        ...
        protected void WriteResultProperties(Diagnostic diagnostic)
        {
            ...
            RoslynDebug.Assert(diagnostic.CustomTags.SequenceEqual(diagnostic.Descriptor.CustomTags));
            RoslynDebug.Assert(diagnostic.Category == diagnostic.Descriptor.Category);
            RoslynDebug.Assert(diagnostic.DefaultSeverity == diagnostic.Descriptor.DefaultSeverity);
            RoslynDebug.Assert(diagnostic.IsEnabledByDefault == diagnostic.Descriptor.IsEnabledByDefault);
        ...
        {
            RoslynDebug.Assert(!string.IsNullOrEmpty(path));
