...
namespace Loretta.CodeAnalysis
{
    public abstract class CommandLineParser
    {
        ...
        internal virtual IEnumerable<string> EnumerateFiles(string? directory, string fileNamePattern, SearchOption searchOption)
        {
            ...
            RoslynDebug.Assert(PathUtilities.IsAbsolute(directory));
            ...
            string? baseDirectory)
        {
            ...
            else
            {
                ...
                RoslynDebug.Assert(outputDirectory is object);
        ...
        internal static void ProcessSlashes(StringBuilder builder, string arg, ref int i)
        {
            ...
            RoslynDebug.Assert(i < arg.Length);
            ...
            if (i < arg.Length && arg[i] == '"')
            {
                ...
                RoslynDebug.Assert(slashCount >= 0);
        ...
        {
            RoslynDebug.Assert(IsScriptCommandLineParser || !arg.StartsWith("-", StringComparison.Ordinal) && !arg.StartsWith("@", StringComparison.Ordinal));
