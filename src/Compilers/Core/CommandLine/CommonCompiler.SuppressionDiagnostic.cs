...
namespace Loretta.CodeAnalysis
{
    internal abstract partial class CommonCompiler
    {
        ...
        private sealed class SuppressionDiagnostic : Diagnostic
        {
            ...
            {
                RoslynDebug.Assert(originalDiagnostic != null);
                RoslynDebug.Assert(originalDiagnostic.ProgrammaticSuppressionInfo != null);
                RoslynDebug.Assert(!string.IsNullOrEmpty(suppressionId));
                RoslynDebug.Assert(suppressionJustification != null);
