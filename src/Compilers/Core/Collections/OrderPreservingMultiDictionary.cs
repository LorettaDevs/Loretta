...
namespace Loretta.CodeAnalysis.Collections
{
        ...
        where V : notnull
    {
        ...
        public static OrderPreservingMultiDictionary<K, V> GetInstance()
        {
            ...
            RoslynDebug.Assert(instance.IsEmpty);
            return instance;
        }
        ...
        public void Add(K k, V v)
        {
            ...
            {
                RoslynDebug.Assert(valueSet.Count >= 1);
        ...
        public struct ValueSet : IEnumerable<V>
        {
            ...
            internal V this[int index]
            {
                get
                {
                    RoslynDebug.Assert(this.Count >= 1);
            ...
            internal ImmutableArray<V> Items
            {
                get
                {
                    ...
                    if (arrayBuilder == null)
                    {
                        ...
                        RoslynDebug.Assert(_value is V, "Item must be a a V");
            ...
            internal ValueSet WithAddedItem(V item)
            {
                ...
                if (arrayBuilder == null)
                {
                    ...
                    RoslynDebug.Assert(_value is V, "_value must be a V");
