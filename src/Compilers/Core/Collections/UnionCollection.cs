...
namespace Loretta.CodeAnalysis
{
    ...
    internal class UnionCollection<T> : ICollection<T>
    {
        ...
        {
            RoslynDebug.Assert(coll1.IsReadOnly && coll2.IsReadOnly);
        ...
        {
            RoslynDebug.Assert(collections.All(c => selector(c).IsReadOnly));
        ...
        {
            RoslynDebug.Assert(!collections.IsDefault);
