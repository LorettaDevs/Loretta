...
namespace Loretta.CodeAnalysis.CodeGen
{
    ...
    internal partial struct SwitchIntegralJumpTableEmitter
    {
        ...
        internal void EmitJumpTable()
        {
            ...
            RoslynDebug.Assert(!_sortedCaseLabels.IsEmpty);
        ...
        private static int CompareIntegralSwitchLabels(KeyValuePair<ConstantValue, object> first, KeyValuePair<ConstantValue, object> second)
        {
            ...
            RoslynDebug.Assert(SwitchConstantValueHelper.IsValidSwitchCaseLabelConstant(firstConstant)
                && !firstConstant.IsString);

            RoslynDebug.Assert(secondConstant != null);
            RoslynDebug.Assert(SwitchConstantValueHelper.IsValidSwitchCaseLabelConstant(secondConstant)
        ...
        {
            RoslynDebug.Assert(startLabelIndex >= 0 && startLabelIndex <= endLabelIndex);
            RoslynDebug.Assert(_sortedCaseLabels.Length > endLabelIndex);
            ...
            RoslynDebug.Assert(!switchBucketsStack.IsEmpty());
        ...
        private object[] CreateBucketLabels(SwitchBucket switchBucket)
        {
            ...
            for (ulong i = 0; i < bucketSize; ++i)
            {
                if (i == nextCaseLabelNormalizedValue)
                {
                    ...
                    {
                        RoslynDebug.Assert(i == bucketSize - 1);
                        break;
                    }
                    ...
                    if (hasNegativeCaseLabels)
                    {
                        ...
                        RoslynDebug.Assert(nextCaseLabelValue > startConstant.Int64Value);
                    ...
                    else
                    {
                        ...
                        RoslynDebug.Assert(nextCaseLabelValue > startConstant.UInt64Value);
            ...
            RoslynDebug.Assert(nextCaseIndex >= switchBucket.LabelsCount);
            return labels;
        }
        ...
        {
            RoslynDebug.Assert(branchCode.IsBranch());
        ...
        private void EmitNormalizedSwitchKey(ConstantValue startConstant, ConstantValue endConstant, object bucketFallThroughLabel)
        {
            ...
            _builder.EmitNumericConversion(_keyTypeCode, Loretta.Cci.PrimitiveTypeCode.UInt32, false);
        }
