    ...
    internal partial class ILBuilder
    {
        ...
        internal class BasicBlock
        {
            ...
            public void AddILMarker(int marker)
            {
                ...
                RoslynDebug.Assert((this.FirstILMarker < 0) == (this.LastILMarker < 0));
                RoslynDebug.Assert((this.LastILMarker < 0) || (this.LastILMarker + 1 == marker));
            ...
            public void RemoveTailILMarker(int marker)
            {
                //  We assume that all IL markers allocated for the same basic block are 
                //  allocated sequentially and don't interleave with markers from other blocks
                RoslynDebug.Assert(this.FirstILMarker >= 0);
                RoslynDebug.Assert(this.LastILMarker >= 0);
                RoslynDebug.Assert(this.LastILMarker == marker);
            ...
            public ILOpCode RevBranchCode
            {
                ...
                set
                {
                    RoslynDebug.Assert((ILOpCode)(byte)value == value, "rev opcodes must fit in a byte");
            ...
            {
                RoslynDebug.Assert(this.BranchCode.IsConditionalBranch() == newBranchCode.IsConditionalBranch());
                RoslynDebug.Assert(newBranchCode.IsBranch() == (_branchLabel != null));
            ...
            public void SetBranch(object newLabel, ILOpCode branchCode)
            {
                ...
                if (_branchLabel != newLabel)
                {
                    ...
                    {
                        RoslynDebug.Assert(newLabel != null);
            ...
            internal void RewriteBranchesAcrossExceptionHandlers()
            {
                if (this.EnclosingHandler == null)
                {
                    ...
                    RoslynDebug.Assert(BranchBlock?.EnclosingHandler == null);
                }
            ...
            internal bool OptimizeBranches(ref int delta)
            {
                ...
                if (this.IsBranchToLabel)
                {
                    RoslynDebug.Assert(BranchCode != ILOpCode.Nop, "Nop branches should not have labels");
            ...
            private bool TryOptimizeBranchOverUncondBranch(BasicBlock next, ref int delta)
            {
                    ...
                    next.BranchBlock != next)
                {
                    ...
                    if (revBrOp != ILOpCode.Nop)
                    {
                        ...
                        {
                            RoslynDebug.Assert(toRemove == next || toRemove.TotalSize == 0);
                            RoslynDebug.Assert(!builder._labelInfos.Values.Any(li => li.bb == toRemove),
            ...
            public virtual int TotalSize
            {
                get
                {
                    ...
                    switch (BranchCode)
                    {
                        ...
                        default:
                            RoslynDebug.Assert(BranchCode.Size() == 1);
        ...
        internal sealed class SwitchBlock : BasicBlockWithHandlerScope
        {
            ...
            public uint BranchesCount
            {
                get
                {
                    RoslynDebug.Assert(BranchLabels != null);
            ...
            public void GetBranchBlocks(ArrayBuilder<BasicBlock> branchBlocksBuilder)
            {
                ...
                RoslynDebug.Assert(BranchesCount > 0);
                RoslynDebug.Assert(branchBlocksBuilder != null);
