...
namespace Loretta.CodeAnalysis.CodeGen
{
    ...
    internal struct SwitchStringJumpTableEmitter
    {
        ...
        {
            RoslynDebug.Assert(_keyHash == null || ShouldGenerateHashTableSwitch(_caseLabels.Length));
        ...
        private void EmitHashTableSwitch()
        {
            ...
            RoslynDebug.Assert(_keyHash != null);
            ...
            GetStringHashCode computeStringHashcodeDelegate)
        {
            ...
            foreach (var kvPair in caseLabels)
            {
                ...
                RoslynDebug.Assert(stringConstant.IsNull || stringConstant.IsString);
                ...
                RoslynDebug.Assert(!bucket.Contains(kvPair));
                bucket.Add(kvPair);
            }
