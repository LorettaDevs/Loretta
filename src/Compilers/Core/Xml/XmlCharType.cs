...
namespace Loretta.CodeAnalysis
{
    ...
    internal static class XmlCharType
    {
        ...
        {
            RoslynDebug.Assert(str != null);
            RoslynDebug.Assert(startPos + len <= str.Length);
            RoslynDebug.Assert(startPos <= str.Length);
        ...
        {
            RoslynDebug.Assert(chars != null);
            RoslynDebug.Assert(startPos + len <= chars.Length);
            RoslynDebug.Assert(startPos <= chars.Length);
