...
namespace Loretta.CodeAnalysis
{
    ...
    public partial class AssemblyIdentity
    {
        ...
        {
            RoslynDebug.Assert(displayName.IndexOf('\0') == -1);
            ...
            RoslynDebug.Assert(i == displayName.Length || IsNameTokenTerminator(displayName[i]));
            position = i;
        ...
        {
            RoslynDebug.Assert(str.Length > 0);
            RoslynDebug.Assert(str.IndexOf('\0') < 0);
