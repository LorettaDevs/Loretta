...
namespace Loretta.CodeAnalysis
{
    ...
    public sealed class AssemblyMetadata : Metadata
    {
        private sealed class Data
        {
            ...
            {
                RoslynDebug.Assert(!modules.IsDefaultOrEmpty && assembly != null);
        ...
        {
            RoslynDebug.Assert(!modules.IsDefaultOrEmpty);
        ...
        internal AssemblyMetadata(ModuleMetadata manifestModule, Func<string, ModuleMetadata> moduleFactory)
            : base(isImageOwner: true, id: MetadataId.CreateNewId())
        {
            RoslynDebug.Assert(manifestModule != null);
            RoslynDebug.Assert(moduleFactory != null);
        ...
        private Data GetOrCreateData()
        {
            if (_lazyData == null)
            {
                ...
                try
                {
                    ...
                    {
                        RoslynDebug.Assert(_initialModules.Length == 1);
        ...
        public override void Dispose()
        {
            ...
            RoslynDebug.Assert(_initialModules.Length == 1 || _initialModules.Length == previousData.Modules.Length);
