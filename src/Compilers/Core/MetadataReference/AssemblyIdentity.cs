...
namespace Loretta.CodeAnalysis
{
    ...
    public sealed partial class AssemblyIdentity : IEquatable<AssemblyIdentity>
    {
        ...
        {
            RoslynDebug.Assert((object)other != null);
            RoslynDebug.Assert((object)version != null);
            ...
            bool hasPublicKey)
        {
            ...
            RoslynDebug.Assert(IsValid(version));
            RoslynDebug.Assert(IsValidCultureName(cultureName));
            RoslynDebug.Assert((hasPublicKey && MetadataHelpers.IsValidPublicKey(publicKeyOrToken)) || (!hasPublicKey && (publicKeyOrToken.IsDefaultOrEmpty || publicKeyOrToken.Length == PublicKeyTokenSize)));
        ...
        public bool IsStrongName
        {
            get
            {
                ...
                RoslynDebug.Assert(HasPublicKey || !_lazyPublicKeyToken.IsDefault);
        ...
        internal static ImmutableArray<byte> CalculatePublicKeyToken(ImmutableArray<byte> publicKey)
        {
            ...
            RoslynDebug.Assert(hash.Length == CryptographicHashProvider.Sha1HashSize);
