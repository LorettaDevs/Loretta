...
#else
namespace Loretta.CodeAnalysis.ErrorReporting
#endif
{
...
#pragma warning restore IDE0052
        ...
        public static Action<Exception>? Handler
        {
            ...
            set
            {
                ...
                {
                    RoslynDebug.Assert(s_fatalHandler == null, "Handler already set");
        ...
        public static Action<Exception>? NonFatalHandler
        {
            ...
            set
            {
                ...
                {
                    RoslynDebug.Assert(s_nonFatalHandler == null, "Handler already set");
