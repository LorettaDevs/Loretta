...
namespace Loretta.CodeAnalysis
{
    internal sealed class StrongNameKeys
    {
        ...
        {
            RoslynDebug.Assert(keyContainerName == null || keyPair.IsDefault);
            RoslynDebug.Assert(keyPair.IsDefault || keyFilePath != null);
        ...
        {
            RoslynDebug.Assert(!publicKey.IsDefaultOrEmpty);
        ...
        internal static Diagnostic GetError(string? keyFilePath, string? keyContainerName, object message, CommonMessageProvider messageProvider)
        {
            ...
            {
                RoslynDebug.Assert(keyFilePath is object);
