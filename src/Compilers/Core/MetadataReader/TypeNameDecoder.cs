...
namespace Loretta.CodeAnalysis
{
        ...
        where TypeSymbol : class
    {
        ...
        protected Loretta.Cci.PrimitiveTypeCode GetPrimitiveTypeCode(TypeSymbol type)
        {
        ...
        internal TypeSymbol GetTypeSymbol(MetadataHelpers.AssemblyQualifiedTypeName fullName, out bool refersToNoPiaLocalType)
        {
            ...
            RoslynDebug.Assert(MetadataHelpers.IsValidMetadataIdentifier(fullName.TopLevelType));
            ...
            if (fullName.NestedTypes != null)
            {
                ...
                {
                    RoslynDebug.Assert(MetadataHelpers.IsValidMetadataIdentifier(fullName.NestedTypes[i]));
