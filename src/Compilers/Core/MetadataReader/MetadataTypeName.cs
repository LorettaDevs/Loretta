...
namespace Loretta.CodeAnalysis
{
    ...
    internal partial struct MetadataTypeName
    {
        ...
        {
            RoslynDebug.Assert(fullName != null);
            RoslynDebug.Assert(forcedArity >= -1 && forcedArity < short.MaxValue);
            RoslynDebug.Assert(forcedArity == -1 ||
        ...
        )
        {
            ...
            RoslynDebug.Assert(forcedArity >= -1 && forcedArity < short.MaxValue);
            RoslynDebug.Assert(!typeName.Contains(MetadataHelpers.DotDelimiterString));
            RoslynDebug.Assert(forcedArity == -1 ||
                         !useCLSCompliantNameArityEncoding ||
        ...
        {
            RoslynDebug.Assert(typeName != null);
            RoslynDebug.Assert(!typeName.Contains(MetadataHelpers.DotDelimiterString) || typeName.IndexOf(MetadataHelpers.MangledNameRegionStartChar) >= 0);
            RoslynDebug.Assert(forcedArity >= -1 && forcedArity < short.MaxValue);
            RoslynDebug.Assert(forcedArity == -1 ||
                         !useCLSCompliantNameArityEncoding ||
                         forcedArity == MetadataHelpers.InferTypeArityFromMetadataName(typeName),
        ...
        public string FullName
        {
            get
            {
                if (_fullName == null)
                {
                    RoslynDebug.Assert(_namespaceName != null);
                    RoslynDebug.Assert(_typeName != null);
        ...
        public string NamespaceName
        {
            get
            {
                ...
                {
                    RoslynDebug.Assert(_fullName != null);
        ...
        public string UnmangledTypeName
        {
            get
            {
                ...
                {
                    RoslynDebug.Assert(_inferredArity == -1);
        ...
        public int InferredArity
        {
            get
            {
                if (_inferredArity == -1)
                {
                    RoslynDebug.Assert(_unmangledTypeName == null);
                    _unmangledTypeName = MetadataHelpers.InferTypeArityAndUnmangleMetadataName(TypeName, out _inferredArity);
                }
