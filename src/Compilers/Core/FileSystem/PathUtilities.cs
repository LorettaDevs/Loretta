...
namespace Loretta.Utilities
{
    ...
    internal static class PathUtilities
    {
        ...
        {
            RoslynDebug.Assert(!IsUnixLikePlatform);
        ...
        {
            RoslynDebug.Assert(IsAbsolute(root));
        ...
        public static bool IsValidFilePath([NotNullWhen(true)] string? fullPath)
        {
            try
            {
                ...
                // RoslynDebug.Assert(IsAbsolute(fullPath));
        ...
        /// </summary>
        /// <remarks>
        /// This method is equivalent to Loretta.CodeAnalysis.BuildTasks.GenerateMSBuildEditorConfig.NormalizeWithForwardSlash
