...
namespace Loretta.CodeAnalysis
{
    ...
    public sealed class EmbeddedText
    {
        ...
        {
            RoslynDebug.Assert(filePath.Length > 0);
            RoslynDebug.Assert(SourceHashAlgorithms.IsSupportedAlgorithm(checksumAlgorithm));
            RoslynDebug.Assert(!blob.IsDefault && blob.Length >= sizeof(int));
        ...
        internal static ImmutableArray<byte> CreateBlob(Stream stream)
        {
            ...
            RoslynDebug.Assert(longLength >= 0);
