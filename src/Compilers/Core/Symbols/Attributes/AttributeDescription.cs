...
namespace Loretta.CodeAnalysis
{
    internal struct AttributeDescription
    {
        ...
        internal int GetParameterCount(int signatureIndex)
        {
            ...
            RoslynDebug.Assert(signature[0] == (byte)SignatureAttributes.Instance);
        ...
        internal static readonly AttributeDescription CodeAnalysisEmbeddedAttribute = new AttributeDescription("Loretta.CodeAnalysis", "EmbeddedAttribute", s_signatures_HasThis_Void_Only);
