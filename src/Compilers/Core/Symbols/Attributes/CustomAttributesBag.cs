...
namespace Loretta.CodeAnalysis
{
        ...
        where T : AttributeData
    {
        ...
        {
            RoslynDebug.Assert(!newCustomAttributes.IsDefault);
        ...
        public ImmutableArray<T> Attributes
        {
            get
            {
                RoslynDebug.Assert(IsPartComplete(CustomAttributeBagCompletionPart.Attributes));
                RoslynDebug.Assert(!_customAttributes.IsDefault);
        ...
        public WellKnownAttributeData DecodedWellKnownAttributeData
        {
            get
            {
                RoslynDebug.Assert(IsPartComplete(CustomAttributeBagCompletionPart.DecodedWellKnownAttributeData));
        ...
        public EarlyWellKnownAttributeData EarlyDecodedWellKnownAttributeData
        {
            get
            {
                RoslynDebug.Assert(IsPartComplete(CustomAttributeBagCompletionPart.EarlyDecodedWellKnownAttributeData));
        ...
        internal bool IsEarlyDecodedWellKnownAttributeDataComputed
        {
            get
            {
                ...
                RoslynDebug.Assert(!IsPartComplete(CustomAttributeBagCompletionPart.DecodedWellKnownAttributeData) || earlyComplete);
        ...
        internal bool IsDecodedWellKnownAttributeDataComputed
        {
            get
            {
                ...
                // If late attributes are complete, early attributes must also be complete
                RoslynDebug.Assert(!attributesComplete || IsPartComplete(CustomAttributeBagCompletionPart.EarlyDecodedWellKnownAttributeData));
