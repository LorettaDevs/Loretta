...
#pragma warning restore CA1802
        ...
        {
#if DEBUG
            RoslynDebug.Assert(_isSealed == expected);
#endif
        }
        ...
        {
#if DEBUG
            RoslynDebug.Assert(_anyDataStored == expected);
#endif
        }
        ...
        internal static void Seal(WellKnownAttributeData data)
        {
            ...
            if (data != null)
            {
                RoslynDebug.Assert(!data._isSealed);
                RoslynDebug.Assert(data._anyDataStored);
                data._isSealed = true;
            }
#endif
        }
