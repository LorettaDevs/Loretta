...
namespace Loretta.CodeAnalysis
{
    ...
    internal sealed class MarshalPseudoCustomAttributeData : Cci.IMarshallingInformation
    {
        ...
        {
            RoslynDebug.Assert(parameterIndex == null || parameterIndex >= 0 && parameterIndex <= MaxMarshalInteger);
        ...
        {
            RoslynDebug.Assert(elementCount == null || elementCount >= 0 && elementCount <= MaxMarshalInteger);
            RoslynDebug.Assert(parameterIndex == null || parameterIndex >= 0);
        ...
        {
            RoslynDebug.Assert(elementCount == null || elementCount >= 0 && elementCount <= MaxMarshalInteger);
            RoslynDebug.Assert(elementType == null || elementType >= 0 && (int)elementType <= MaxMarshalInteger);
        ...
        {
            RoslynDebug.Assert(elementCount >= 0 && elementCount <= MaxMarshalInteger);
        ...
        {
            RoslynDebug.Assert(type >= 0 && (int)type <= MaxMarshalInteger);
            _marshalType = type;
        }
        ...
        {
            RoslynDebug.Assert(_marshalType == Cci.Constants.UnmanagedType_CustomMarshaler);
            ...
            {
                RoslynDebug.Assert(_marshalTypeNameOrSymbol == null || _marshalTypeNameOrSymbol is string);
        ...
        int Cci.IMarshallingInformation.NumberOfElements
        {
            get
            {
                RoslynDebug.Assert(_marshalType == UnmanagedType.ByValTStr || _marshalType == UnmanagedType.LPArray || _marshalType == Cci.Constants.UnmanagedType_SafeArray || _marshalType == UnmanagedType.ByValArray);
        ...
        short Cci.IMarshallingInformation.ParamIndex
        {
            get
            {
                RoslynDebug.Assert(_marshalType == UnmanagedType.LPArray && _marshalParameterIndex <= short.MaxValue);
        ...
        UnmanagedType Cci.IMarshallingInformation.ElementType
        {
            get
            {
                RoslynDebug.Assert(_marshalType == UnmanagedType.LPArray || _marshalType == UnmanagedType.ByValArray);
        ...
        Cci.VarEnum Cci.IMarshallingInformation.SafeArrayElementSubtype
        {
            get
            {
                RoslynDebug.Assert(_marshalType == Cci.Constants.UnmanagedType_SafeArray);
