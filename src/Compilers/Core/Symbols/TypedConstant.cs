...
namespace Loretta.CodeAnalysis
{
    ...
    public struct TypedConstant : IEquatable<TypedConstant>
    {
        ...
        {
            RoslynDebug.Assert(kind == TypedConstantKind.Array || !(value is ImmutableArray<TypedConstant>));
            RoslynDebug.Assert(!(value is ISymbol) || value is ISymbolInternal);
            RoslynDebug.Assert(type is object || kind == TypedConstantKind.Error);
        ...
        {
            RoslynDebug.Assert(Kind == TypedConstantKind.Enum);
