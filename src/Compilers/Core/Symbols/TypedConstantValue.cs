...
namespace Loretta.CodeAnalysis
{
    ...
    internal struct TypedConstantValue : IEquatable<TypedConstantValue>
    {
        ...
        {
            RoslynDebug.Assert(value == null || value is string || value.GetType().GetTypeInfo().IsEnum || (value.GetType().GetTypeInfo().IsPrimitive && !(value is System.IntPtr) && !(value is System.UIntPtr)) || value is ITypeSymbol);
            _value = value;
        }
        ...
        public object? Object
        {
            get
            {
                RoslynDebug.Assert(!(_value is ImmutableArray<TypedConstant>));
                return _value;
            }
        }
