...
using Loretta.CodeAnalysis.Emit.NoPia;
...
namespace Loretta.CodeAnalysis.Emit
{
    internal abstract class CommonPEModuleBuilder : Cci.IUnit, Cci.IModuleReference
    {
        ...
        {
            RoslynDebug.Assert(manifestResources != null);
            RoslynDebug.Assert(serializationProperties != null);
        ...
        {
            RoslynDebug.Assert(ReferenceEquals(context.Module, this));
            return this;
        }
        ...
        {
            RoslynDebug.Assert(methodSymbol.ContainingModule == CommonSourceModule);
            RoslynDebug.Assert(methodSymbol.IsDefinition);
            RoslynDebug.Assert(((IMethodSymbol)methodSymbol.GetISymbol()).PartialDefinitionPart == null); // Must be definition.
        ...
        public void SetMethodBody(IMethodSymbolInternal methodSymbol, Cci.IMethodBody body)
        {
            ...
            RoslynDebug.Assert(methodSymbol.IsDefinition);
            RoslynDebug.Assert(((IMethodSymbol)methodSymbol.GetISymbol()).PartialDefinitionPart == null); // Must be definition.
            RoslynDebug.Assert(body == null || (object)methodSymbol == body.MethodDefinition.GetInternalSymbol());
        ...
        {
            RoslynDebug.Assert(method == null || IsSourceDefinition(method));
            RoslynDebug.Assert(OutputKind.IsApplication());
        ...
        {
            RoslynDebug.Assert(TestData == null);
            TestData = methods;
        }
    }
        ...
        where TModuleCompilationState : ModuleCompilationState<TNamedTypeSymbol, TMethodSymbol>
    {
        ...
        {
            RoslynDebug.Assert(sourceModule != null);
            RoslynDebug.Assert(serializationProperties != null);
        ...
        public override IEnumerable<Cci.INamespaceTypeDefinition> GetTopLevelTypeDefinitions(EmitContext context)
        {
            ...
            if (names != null)
            {
                RoslynDebug.Assert(_namesOfTopLevelTypes == null);
        ...
        {
            RoslynDebug.Assert(container.IsDefinition);
        ...
        {
            RoslynDebug.Assert(property != null);
        ...
        {
            RoslynDebug.Assert(nestedType != null);
        ...
        {
            RoslynDebug.Assert(typeOrNamespace != null);
        ...
        {
            RoslynDebug.Assert(this.SupportsPrivateImplClass);
        ...
        {
            RoslynDebug.Assert((object)this == context.Module);
