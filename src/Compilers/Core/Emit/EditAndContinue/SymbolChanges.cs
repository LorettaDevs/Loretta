...
namespace Loretta.CodeAnalysis.Emit
{
    internal abstract class SymbolChanges
    {
        ...
        {
            RoslynDebug.Assert(definitionMap != null);
            RoslynDebug.Assert(edits != null);
            RoslynDebug.Assert(isAddedSymbol != null);
        ...
        private static IReadOnlyDictionary<ISymbol, SymbolChange> CalculateChanges(IEnumerable<SemanticEdit> edits)
        {
            ...
            foreach (var edit in edits)
            {
                ...
                if (member.Kind == SymbolKind.Method)
                {
                    ...
                    RoslynDebug.Assert(method.PartialImplementationPart == null);
                    RoslynDebug.Assert((edit.OldSymbol == null) || (((IMethodSymbol)edit.OldSymbol).PartialImplementationPart == null));
