...
namespace Loretta.CodeAnalysis.FlowAnalysis
{
    internal sealed partial class ControlFlowGraphBuilder : OperationVisitor<int?, IOperation>
    {
        ...
        private RegionBuilder CurrentRegionRequired
        {
            get
            {
                RoslynDebug.Assert(_currentRegion != null);
        ...
        public static ControlFlowGraph Create(IOperation body, ControlFlowGraph? parent = null, ControlFlowRegion? enclosing = null, CaptureIdDispenser? captureIdDispenser = null, in Context context = default)
        {
            ...
            RoslynDebug.Assert(((Operation)body).OwningSemanticModel != null);

#if DEBUG
            if (enclosing == null)
            {
                RoslynDebug.Assert(body.Parent == null);
                RoslynDebug.Assert(body.Kind == OperationKind.Block ||
            ...
            {
                RoslynDebug.Assert(body.Kind == OperationKind.LocalFunction || body.Kind == OperationKind.AnonymousFunction);
                RoslynDebug.Assert(parent != null);
            }
#endif
            ...
            switch (body.Kind)
            {
                case OperationKind.LocalFunction:
                    RoslynDebug.Assert(captureIdDispenser != null);
            ...
            RoslynDebug.Assert(builder._currentRegion == null);
            ...
            RoslynDebug.Assert(builder._evalStack.Count == 0);
            ...
            out bool fellThrough)
        {
            ...
            do
            {
                ...
                {
                    RoslynDebug.Assert(outOfRangeBlocksToVisit != null);
                ...
                RoslynDebug.Assert(current.Region != null);
            ...
            void followBranch(BasicBlockBuilder current, in BasicBlockBuilder.Branch branch)
            {
                switch (branch.Kind)
                {
                    ...
                    case ControlFlowBranchSemantics.Error:
                        RoslynDebug.Assert(branch.Destination == null);
                        return;
            ...
            bool stepThroughFinally(ControlFlowRegion region, BasicBlockBuilder destination)
            {
                ...
                {
                    RoslynDebug.Assert(region.Kind != ControlFlowRegionKind.Root);
                    RoslynDebug.Assert(region.EnclosingRegion != null);
                    ...
                    {
                        RoslynDebug.Assert(enclosing.NestedRegions[0] == region);
                        RoslynDebug.Assert(enclosing.NestedRegions[1].Kind == ControlFlowRegionKind.Finally);
            ...
            {
                RoslynDebug.Assert(@finally.Kind == ControlFlowRegionKind.Finally);
            ...
            void dispatchException([DisallowNull] ControlFlowRegion? fromRegion)
            {
                do
                {
                    ...
                    if (fromRegion.Kind == ControlFlowRegionKind.Try)
                    {
                        switch (enclosing!.Kind)
                        {
                            case ControlFlowRegionKind.TryAndFinally:
                                RoslynDebug.Assert(enclosing.NestedRegions[0] == fromRegion);
                                RoslynDebug.Assert(enclosing.NestedRegions[1].Kind == ControlFlowRegionKind.Finally);
                                if (!stepThroughSingleFinally(enclosing.NestedRegions[1]))
                                {
                                    // The point that continues dispatch is not reachable. Cancel the dispatch.
                    ...
                    else if (fromRegion.Kind == ControlFlowRegionKind.Filter)
                    {
                        ...
                        RoslynDebug.Assert(enclosing!.Kind == ControlFlowRegionKind.FilterAndHandler);
                        RoslynDebug.Assert(enclosing.EnclosingRegion != null);
                        ControlFlowRegion tryAndCatch = enclosing.EnclosingRegion;
                        RoslynDebug.Assert(tryAndCatch.Kind == ControlFlowRegionKind.TryAndCatch);
            ...
            void dispatchExceptionThroughCatches(ControlFlowRegion tryAndCatch, int startAt)
            {
                ...
                RoslynDebug.Assert(tryAndCatch.Kind == ControlFlowRegionKind.TryAndCatch);
                RoslynDebug.Assert(startAt > 0);
                RoslynDebug.Assert(startAt <= tryAndCatch.NestedRegions.Length);
                ...
                for (int i = startAt; i < tryAndCatch.NestedRegions.Length; i++)
                {
                    ...
                    switch (@catch.Kind)
                    {
                        ...
                        case ControlFlowRegionKind.FilterAndHandler:
                            ...
                            RoslynDebug.Assert(@catch.NestedRegions[0].Kind == ControlFlowRegionKind.Filter);
                            RoslynDebug.Assert(entryBlock.Ordinal == @catch.NestedRegions[0].FirstBlockOrdinal);
        ...
        private static bool PackRegions(RegionBuilder root, ArrayBuilder<BasicBlockBuilder> blocks, PooledDictionary<BasicBlockBuilder, RegionBuilder> regionMap)
        {
            ...
            {
                RoslynDebug.Assert(!region.IsEmpty);
                bool result = false;
        ...
        {
            RoslynDebug.Assert(subRegion.Kind != ControlFlowRegionKind.Root);
            RoslynDebug.Assert(subRegion.Enclosing != null);
            ...
            {
                RoslynDebug.Assert(canHaveEmptyRegion);
                RoslynDebug.Assert(!subRegion.HasRegions);
            ...
            if (subRegion.HasRegions)
            {
                ...
                {
                    RoslynDebug.Assert(!r.IsEmpty);
                    for (int i = firstBlockToMove; i < r.FirstBlock.Ordinal; i++)
                    {
                        RoslynDebug.Assert(regionMap[blocks[i]] == subRegion);
        ...
        private static bool PackBlocks(ArrayBuilder<BasicBlockBuilder> blocks, PooledDictionary<BasicBlockBuilder, RegionBuilder> regionMap)
        {
            ...
            do
            {
                ...
                for (int i = 1; i < count; i++)
                {
                    ...
                    if (block.HasStatements)
                    {
                        ...
                        {
                            RoslynDebug.Assert(predecessor.BranchValue == null);
                            RoslynDebug.Assert(predecessor.FallThrough.Kind == ControlFlowBranchSemantics.Regular);
                    ...
                    RoslynDebug.Assert((block.BranchValue != null && !block.HasCondition) == (next.Kind == ControlFlowBranchSemantics.Return || next.Kind == ControlFlowBranchSemantics.Throw));
                    RoslynDebug.Assert((next.Destination == null) ==
                    ...
                    if (next.Kind == ControlFlowBranchSemantics.StructuredExceptionHandling)
                    {
                        ...
                        RoslynDebug.Assert(currentRegion.Kind == ControlFlowRegionKind.Filter ||
                                     currentRegion.Kind == ControlFlowRegionKind.Finally);
                        RoslynDebug.Assert(block == currentRegion.LastBlock);
                    }
#endif
                    ...
                    if (!block.HasCondition)
                    {
                        ...
                        {
                            RoslynDebug.Assert(currentRegion.FirstBlock == block);
                            RoslynDebug.Assert(!currentRegion.HasRegions);
                                ...
                                !block.HasPredecessors)
                            {
                                ...
                                RoslynDebug.Assert(currentRegion.Enclosing != null);
                                RegionBuilder tryAndFinally = currentRegion.Enclosing;
                                RoslynDebug.Assert(tryAndFinally.Kind == ControlFlowRegionKind.TryAndFinally);
                                RoslynDebug.Assert(tryAndFinally.Regions!.Count == 2);

                                RegionBuilder @try = tryAndFinally.Regions.First();
                                RoslynDebug.Assert(@try.Kind == ControlFlowRegionKind.Try);
                                RoslynDebug.Assert(tryAndFinally.Regions.Last() == currentRegion);
                                ...
                                {
                                    RoslynDebug.Assert(@try.FirstBlock != null);
                        ...
                        if (next.Kind == ControlFlowBranchSemantics.StructuredExceptionHandling)
                        {
                            RoslynDebug.Assert(block.HasCondition || block.BranchValue == null);
                            RoslynDebug.Assert(next.Destination == null);
                        ...
                        {
                            RoslynDebug.Assert(next.Kind == ControlFlowBranchSemantics.Regular ||
                            ...
                            RoslynDebug.Assert(!block.HasCondition); // This is ensured by an "if" above.
                            ...
                            if (implicitEntryRegion != null)
                            {
                                ...
                                RoslynDebug.Assert(implicitEntryRegion.LastBlock!.Ordinal >= next.Destination.Ordinal);
                            }
                            ...
                            if (value != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    RoslynDebug.Assert(predecessor.FallThrough.Destination == block);
                                }
                            }
                    ...
                    else
                    {
                        ...
                        if (predecessor.Kind != BasicBlockKind.Entry &&
                            ...
                            regionMap[predecessor] == currentRegion)
                        {
                            RoslynDebug.Assert(predecessor != block);
                            RoslynDebug.Assert(predecessor.BranchValue == null);
            ...
            {
                RoslynDebug.Assert(!region.IsEmpty);
                RoslynDebug.Assert(region.FirstBlock.Ordinal >= 0);
                RoslynDebug.Assert(region.FirstBlock.Ordinal <= region.LastBlock.Ordinal);
                RoslynDebug.Assert(region.FirstBlock.Ordinal <= block.Ordinal);
                RoslynDebug.Assert(block.Ordinal <= region.LastBlock.Ordinal);

                if (region.FirstBlock == block)
                {
                    BasicBlockBuilder newFirst = blocks[block.Ordinal + 1];
                    region.FirstBlock = newFirst;
                    RoslynDebug.Assert(region.Enclosing != null);
                    RegionBuilder enclosing = region.Enclosing;
                    while (enclosing != null && enclosing.FirstBlock == block)
                    {
                        enclosing.FirstBlock = newFirst;
                        RoslynDebug.Assert(enclosing.Enclosing != null);
                ...
                RoslynDebug.Assert(removed);
                RoslynDebug.Assert(blocks[block.Ordinal] == block);
            ...
            void mergeBranch(BasicBlockBuilder predecessor, ref BasicBlockBuilder.Branch predecessorBranch, ref BasicBlockBuilder.Branch successorBranch)
            {
                ...
                RoslynDebug.Assert(predecessorBranch.Kind == ControlFlowBranchSemantics.Regular);
        ...
        private static void CheckUnresolvedBranches(ArrayBuilder<BasicBlockBuilder> blocks, PooledDictionary<ILabelSymbol, BasicBlockBuilder>? labeledBlocks)
        {
            ...
            void fixupBranch(ref BasicBlockBuilder.Branch branch)
            {
                ...
                {
                    RoslynDebug.Assert(branch.Kind == ControlFlowBranchSemantics.Regular);
        ...
        private void VisitStatement(IOperation? operation)
        {
            ...
            RoslynDebug.Assert(stackDepth == 0 || _evalStack.Peek().frameOpt != null);
#endif
            if (operation == null)
            {
                return;
...
#if DEBUG
            RoslynDebug.Assert(_evalStack.Count == stackDepth);
            RoslynDebug.Assert(stackDepth == 0 || _evalStack.Peek().frameOpt != null);
#endif
        ...
        {
#if DEBUG
            RoslynDebug.Assert(spillingTheStack || _evalStack.All(
        ...
        private void EnterRegion(RegionBuilder region, bool spillingStack = false)
        {
            if (!spillingStack)
            {
                ...
                SpillEvalStack();
#if DEBUG
                RoslynDebug.Assert(_evalStack.Count == _startSpillingAt);
        ...
        private void LeaveRegion()
        {
            ...
            {
                RoslynDebug.Assert((frameOpt == null) != (operationOpt == null));

                if (frameOpt != null)
                {
                    RoslynDebug.Assert(enclosed != frameOpt.RegionBuilderOpt);
                }
            }
#endif
            _currentRegion = _currentRegion.Enclosing;
            RoslynDebug.Assert(enclosed.LastBlock != null);
        ...
        {
            RoslynDebug.Assert(prevBlock.HasCondition || prevBlock.BranchValue == null);
            RoslynDebug.Assert(prevBlock.FallThrough.Destination == null);
        ...
        {
            RoslynDebug.Assert(_currentStatement == operation);
            RoslynDebug.Assert(_evalStack.Count == 0 || _evalStack.Peek().frameOpt != null);
            SpillEvalStack();
        }
        ...
        {
            RoslynDebug.Assert(((Operation)originalOperation).OwningSemanticModel != null, "Not an original node.");
            RoslynDebug.Assert(_currentStatement == originalOperation);
            RoslynDebug.Assert(_evalStack.Count == 0 || _evalStack.Peek().frameOpt != null);
        ...
        public override IOperation? VisitConditional(IConditionalOperation operation, int? captureIdForResult)
        {
            ...
            else
            {
                ...
                RoslynDebug.Assert(operation is { WhenTrue: not null, WhenFalse: not null });
                ...
                if (operation.WhenTrue is IConversionOperation whenTrueConversion && whenTrueConversion.Operand.Kind == OperationKind.Throw)
                {
                    ...
                    RoslynDebug.Assert(rewrittenThrow!.Kind == OperationKind.None);
                    RoslynDebug.Assert(rewrittenThrow.Children.IsEmpty());
        ...
        {
            RoslynDebug.Assert(_startSpillingAt == _evalStack.Count);
        ...
        private class EvalStackFrame
        {
            ...
            public RegionBuilder? RegionBuilderOpt
            {
                ...
                set
                {
                    RoslynDebug.Assert(_lazyRegionBuilder == null);
                    RoslynDebug.Assert(value != null);
        ...
        {
            RoslynDebug.Assert(frame != null);
            int stackDepth = _evalStack.Count;
            RoslynDebug.Assert(_startSpillingAt <= stackDepth);
            ...
            RoslynDebug.Assert(frame == frameOpt);
            RoslynDebug.Assert(operationOpt == null);
            ...
            if (frame.RegionBuilderOpt != null && mergeNestedRegions)
            {
                while (_currentRegion != frame.RegionBuilderOpt)
                {
                    ...
                    RoslynDebug.Assert(toMerge.Enclosing != null);
                    _currentRegion = toMerge.Enclosing;

                    RoslynDebug.Assert(toMerge.IsStackSpillRegion);
                    RoslynDebug.Assert(!toMerge.HasLocalFunctions);
                    RoslynDebug.Assert(toMerge.Locals.IsEmpty);
        ...
        private void LeaveRegionIfAny(EvalStackFrame frame)
        {
            ...
            if (toLeave != null)
            {
                ...
                {
                    RoslynDebug.Assert(_currentRegion!.IsStackSpillRegion);
                    LeaveRegion();
                }
        ...
        private void SpillEvalStack()
        {
            ...
            for (int i = _startSpillingAt - 1; i >= 0; i--)
            {
                ...
                {
                    currentFrameIndex = i;
                    RoslynDebug.Assert(frameOpt.RegionBuilderOpt != null);
                    break;
                }
            }
            ...
            for (int i = _startSpillingAt; i < _evalStack.Count; i++)
            {
                    ...
                    && operationOpt.Kind != OperationKind.OmittedArgument)
                {
                    ...
                    RoslynDebug.Assert(currentFrame != null);
                    RegionBuilder? currentSpillRegion = currentFrame.RegionBuilderOpt;
                    RoslynDebug.Assert(currentSpillRegion != null);
                    ...
                    if (_currentRegion != currentSpillRegion)
                    {
                        ...
                        do
                        {
                            RoslynDebug.Assert(candidate.IsStackSpillRegion);
                            ...
                            RoslynDebug.Assert(candidate.Enclosing != null);
                    ...
                    {
                        RoslynDebug.Assert(CurrentRegionRequired.IsStackSpillRegion);
                        LeaveRegion();
                    }
                }
            }
        ...
        {
            RoslynDebug.Assert(_evalStack.Count != 0);
            RoslynDebug.Assert(_evalStack.First().frameOpt != null);
            RoslynDebug.Assert(_evalStack.First().operationOpt == null);
            RoslynDebug.Assert(_startSpillingAt <= _evalStack.Count);
            RoslynDebug.Assert(operation != null);
        ...
        private IOperation PopOperand()
        {
            ...
            (EvalStackFrame? frameOpt, IOperation? operationOpt) = _evalStack.Pop();
            RoslynDebug.Assert(frameOpt == null);
            RoslynDebug.Assert(operationOpt != null);
        ...
        {
            RoslynDebug.Assert(unwrapper != null || typeof(T) == typeof(IOperation));
        ...
        {
            RoslynDebug.Assert(wrapper != null || typeof(T) == typeof(IOperation));
...
#if DEBUG
            RoslynDebug.Assert(stackSizeBefore == _evalStack.Count);
#endif
        ...
        {
            RoslynDebug.Assert(index >= 0 && index < args.Length);
        ...
        private IOperation VisitObjectBinaryConditionalOperator(IBinaryOperation binOp, int? captureIdForResult)
        {
            ...
            RoslynDebug.Assert(binOp.Type is not null);
        ...
        private IOperation VisitDynamicBinaryConditionalOperator(IBinaryOperation binOp, int? captureIdForResult)
        {
            ...
            {
                RoslynDebug.Assert(unaryOperatorMethod == null);
        ...
        private IOperation VisitUserDefinedBinaryConditionalOperator(IBinaryOperation binOp, int? captureIdForResult)
        {
            ...
            if (ITypeSymbolHelpers.IsNullableType(left.Type))
            {
                if (unaryOperatorMethod == null ? isLifted : !ITypeSymbolHelpers.IsNullableType(unaryOperatorMethod.Parameters[0].Type))
                {
                    ...
                    RoslynDebug.Assert(unaryOperatorMethod == null || !ITypeSymbolHelpers.IsNullableType(unaryOperatorMethod.Parameters[0].Type));
        ...
        {
            RoslynDebug.Assert(IsBooleanConditionalOperator(condition));
        ...
        {
            RoslynDebug.Assert(ITypeSymbolHelpers.IsBooleanType(condition.Type));
...
#if DEBUG
            RoslynDebug.Assert(current == _currentRegion);
#endif
        }
...
oneMoreTime:
            ...
            switch (condition.Kind)
            {
                ...
                case OperationKind.Conversion:
                    ...
                    if (conversion.Operand.Kind == OperationKind.Throw)
                    {
                        ...
                        RoslynDebug.Assert(rewrittenThrow != null);
                        RoslynDebug.Assert(rewrittenThrow.Kind == OperationKind.None);
                        RoslynDebug.Assert(rewrittenThrow.Children.IsEmpty());
                        dest = dest ?? new BasicBlockBuilder(BasicBlockKind.Block);
                        return;
        ...
        private void ConditionalBranch(IOperation condition, bool jumpIfTrue, BasicBlockBuilder destination)
        {
            ...
            RoslynDebug.Assert(previous.BranchValue == null);
            RoslynDebug.Assert(!previous.HasCondition);
            RoslynDebug.Assert(condition != null);
            RoslynDebug.Assert(branch.Destination != null);
        ...
        {
            RoslynDebug.Assert(_evalStack.Last().frameOpt != null);
            RoslynDebug.Assert(_startSpillingAt >= _evalStack.Count - 1);
        ...
        public override IOperation VisitCoalesce(ICoalesceOperation operation, int? captureIdForResult)
        {
            ...
            if (alternativeThrows)
            {
                ...
                RoslynDebug.Assert(conversion is not null);
                IOperation? rewrittenThrow = base.Visit(conversion.Operand, null);
                RoslynDebug.Assert(rewrittenThrow != null);
                RoslynDebug.Assert(rewrittenThrow.Kind == OperationKind.None);
                RoslynDebug.Assert(rewrittenThrow.Children.IsEmpty());
        ...
        public override IOperation? VisitCoalesceAssignment(ICoalesceAssignmentOperation operation, int? captureIdForResult)
        {
            ...
            SpillEvalStack();
            RoslynDebug.Assert(valueFrame.RegionBuilderOpt != null);
            ...
            void nullableValueTypeReturn()
            {
                ...
                if (!isStatement)
                {
                    ...
                    SpillEvalStack();
                    RoslynDebug.Assert(intermediateFrame.RegionBuilderOpt != null);
                ...
                if (!isStatement)
                {
                    RoslynDebug.Assert(intermediateFrame != null);
                    _currentBasicBlock = null;
                    AddStatement(
                ...
                if (!isStatement)
                {
                    RoslynDebug.Assert(whenNullFrame.RegionBuilderOpt != null);
        ...
        {
            RoslynDebug.Assert(ITypeSymbolHelpers.IsBooleanType(booleanType));
        ...
        {
            RoslynDebug.Assert(nullableMember == SpecialMember.System_Nullable_T_GetValueOrDefault ||
            ...
            RoslynDebug.Assert(ITypeSymbolHelpers.IsNullableType(valueType));
        ...
        {
            RoslynDebug.Assert(ITypeSymbolHelpers.IsNullableType(value.Type));
        ...
        public override IOperation? VisitConditionalAccess(IConditionalAccessOperation operation, int? captureIdForResult)
        {
            ...
            while (true)
            {
                ...
                if (!isConditionalAccessInstancePresentInChildren(currentConditionalAccess.WhenNotNull))
                {
                    ...
                    //                      See Loretta.CodeAnalysis.VisualBasic.ExpressionEvaluator.UnitTests.ExpressionCompilerTests.ConditionalAccessExpressionType
            ...
            if (isOnStatementLevel)
            {
                RoslynDebug.Assert(captureIdForResult == null);
                ...
                {
                    RoslynDebug.Assert(_currentStatement is not null);
            ...
            {
                RoslynDebug.Assert(expressionFrame != null);
                int resultCaptureId = captureIdForResult ?? GetNextCaptureId(resultCaptureRegion);
            ...
            {
                RoslynDebug.Assert(!_currentConditionalAccessTracker.IsDefault);
                RoslynDebug.Assert(_currentConditionalAccessTracker.Operations.Count == 0);
        ...
        {
            RoslynDebug.Assert(!_currentConditionalAccessTracker.IsDefault && _currentConditionalAccessTracker.Operations.Count > 0);
        ...
        public override IOperation? VisitExpressionStatement(IExpressionStatementOperation operation, int? captureIdForResult)
        {
            ...
            if (underlying == null)
            {
                RoslynDebug.Assert(operation.Operation.Kind == OperationKind.ConditionalAccess || operation.Operation.Kind == OperationKind.CoalesceAssignment);
                return FinishVisitingStatement(operation);
            }
        ...
        public override IOperation? VisitWhileLoop(IWhileLoopOperation operation, int? captureIdForResult)
        {
            ...
            if (operation.ConditionIsTop)
            {
                ...
                RoslynDebug.Assert(operation.Condition is not null);
            ...
            RoslynDebug.Assert(_currentRegion == locals);
            LeaveRegion();
        ...
        public override IOperation? VisitTry(ITryOperation operation, int? captureIdForResult)
        {
            ...
            RoslynDebug.Assert(CurrentRegionRequired.Kind == ControlFlowRegionKind.Try);
            VisitStatement(operation.Body);
            ...
            if (haveCatches)
            {
                ...
                foreach (ICatchClauseOperation catchClause in operation.Catches)
                {
                    ...
                    if (haveFilter)
                    {
                        ...
                        RoslynDebug.Assert(!filterRegion.IsEmpty);
                        RoslynDebug.Assert(filterRegion.LastBlock.FallThrough.Destination == null);
                        RoslynDebug.Assert(!filterRegion.FirstBlock.HasPredecessors);
                    }
                    ...
                    RoslynDebug.Assert(!handlerRegion.IsEmpty);
                    if (haveFilter)
                    {
                        RoslynDebug.Assert(CurrentRegionRequired == filterAndHandlerRegion);
                        LeaveRegion();
#if DEBUG
                        RoslynDebug.Assert(filterAndHandlerRegion.Regions![0].LastBlock!.FallThrough.Destination == null);
                        if (handlerRegion.FirstBlock.HasPredecessors)
                        {
                            ...
                            RoslynDebug.Assert(predecessors.All(p => filterAndHandlerRegion.Regions[0].FirstBlock!.Ordinal <= p.Ordinal &&
                    ...
                    {
                        RoslynDebug.Assert(!handlerRegion.FirstBlock.HasPredecessors);
                    }
                }

                RoslynDebug.Assert(CurrentRegionRequired.Kind == ControlFlowRegionKind.TryAndCatch);
                LeaveRegion();
            }
            ...
            if (haveFinally)
            {
                ...
                continueDispatchBlock.FallThrough.Kind = ControlFlowBranchSemantics.StructuredExceptionHandling;
                LeaveRegion();
                RoslynDebug.Assert(_currentRegion == tryAndFinallyRegion);
                LeaveRegion();
                RoslynDebug.Assert(!finallyRegion.IsEmpty);
                RoslynDebug.Assert(finallyRegion.LastBlock.FallThrough.Destination == null);
                RoslynDebug.Assert(!finallyRegion.FirstBlock.HasPredecessors);
            }

            AppendNewBlock(afterTryCatchFinally, linkToPrevious: false);
            RoslynDebug.Assert(tryAndFinallyRegion?.Regions![1].LastBlock!.FallThrough.Destination == null);
        ...
        public override IOperation? VisitReturn(IReturnOperation operation, int? captureIdForResult)
        {
            ...
            switch (operation.Kind)
            {
                ...
                case OperationKind.Return:
                    ...
                    RoslynDebug.Assert(current.BranchValue == null);
                    RoslynDebug.Assert(!current.HasCondition);
        ...
        private void LinkThrowStatement(IOperation? exception)
        {
            ...
            RoslynDebug.Assert(current.BranchValue == null);
            RoslynDebug.Assert(!current.HasCondition);
            RoslynDebug.Assert(current.FallThrough.Destination == null);
            RoslynDebug.Assert(current.FallThrough.Kind == ControlFlowBranchSemantics.None);
        ...
        private void HandleUsingOperationParts(IOperation resources, IOperation body, IMethodSymbol? disposeMethod, ImmutableArray<IArgumentOperation> disposeArguments, ImmutableArray<ILocalSymbol> locals, bool isAsynchronous)
        {
            ...
            {
                RoslynDebug.Assert(resources.Kind != OperationKind.VariableDeclaration);
                RoslynDebug.Assert(resources.Kind != OperationKind.VariableDeclarator);
            ...
            RoslynDebug.Assert(_currentRegion == usingRegion);
            LeaveRegion();
            ...
            void processResource(IOperation resource, ArrayBuilder<(IVariableDeclarationOperation, IVariableDeclaratorOperation)>? resourceQueueOpt)
            {
                ...
                RoslynDebug.Assert(CurrentRegionRequired.Kind == ControlFlowRegionKind.TryAndFinally);
                LeaveRegion();

                if (resourceRegion != null)
                {
                    RoslynDebug.Assert(_currentRegion == resourceRegion);
                    LeaveRegion();
                }
        ...
        private void AddDisposingFinally(IOperation resource, bool requiresRuntimeConversion, ITypeSymbol iDisposable, IMethodSymbol? disposeMethod, ImmutableArray<IArgumentOperation> disposeArguments, bool isAsynchronous)
        {
            ...
            {
                RoslynDebug.Assert(!isNotNullableValueType(resource.Type));
            ...
            RoslynDebug.Assert(_currentRegion == finallyRegion);
            LeaveRegion();
            return;

            IOperation? tryDispose(IOperation value)
            {
                RoslynDebug.Assert((disposeMethod is object && !disposeArguments.IsDefault) || (value.Type!.Equals(iDisposable) && disposeArguments.IsDefaultOrEmpty));
        ...
        {
            RoslynDebug.Assert(iDisposable.SpecialType == SpecialType.System_IDisposable ||
        ...
        public override IOperation? VisitLock(ILockOperation operation, int? captureIdForResult)
        {
            ...
            if (legacyMode)
            {
                RoslynDebug.Assert(lockStatement.LockTakenSymbol == null);
            ...
            {
                // Monitor.Enter($lock, ref $lockTaken);
                RoslynDebug.Assert(lockStatement.LockTakenSymbol is not null);
                RoslynDebug.Assert(enterMethod is not null);
        ...
        public override IOperation? VisitForEachLoop(IForEachLoopOperation operation, int? captureIdForResult)
        {
            ...
            {
                RoslynDebug.Assert(regionForCollection == _currentRegion);
                LeaveRegion();
            }
            ...
            VisitStatement(operation.Body);
            RoslynDebug.Assert(localsRegion == _currentRegion);
            UnconditionalBranch(@continue);
            ...
            {
                var afterTryFinally = new BasicBlockBuilder(BasicBlockKind.Block);
                RoslynDebug.Assert(_currentRegion.Kind == ControlFlowRegionKind.Try);
                UnconditionalBranch(afterTryFinally);
                ...
                RoslynDebug.Assert(_currentRegion.Kind == ControlFlowRegionKind.TryAndFinally);
                LeaveRegion();

                AppendNewBlock(afterTryFinally, linkToPrevious: false);
            }

            RoslynDebug.Assert(_currentRegion == enumeratorCaptureRegion);
            LeaveRegion();
            ...
            IOperation getLoopControlVariableAssignment(IOperation current)
            {
                switch (operation.LoopControlVariable.Kind)
                {
                    ...
                    case OperationKind.DeclarationExpression:
                        RoslynDebug.Assert(info?.ElementConversion?.ToCommonConversion().IsIdentity != false);
            ...
            {
                RoslynDebug.Assert(method.IsStatic == (instanceOpt == null));
        ...
        public override IOperation? VisitForToLoop(IForToLoopOperation operation, int? captureIdForResult)
        {
            ...
            {
                RoslynDebug.Assert(isObjectLoop && loopObject is not null);
                ...
                if (method is null)
                {
                    ...
                    RoslynDebug.Assert(builder.All(o => o != null));
                ...
                else
                {
                    ...
                    RoslynDebug.Assert(builder.All(op => op is not null));
            ...
            void initializeLoop()
            {
                ...
                else
                {
                    ...
                    {
                        RoslynDebug.Assert(_forToLoopBinaryOperatorLeftOperand == null);
                        RoslynDebug.Assert(_forToLoopBinaryOperatorRightOperand == null);
            ...
            void checkLoopCondition()
            {
                ...
                else if (userDefinedInfo != null)
                {
                    ...
                    RoslynDebug.Assert(positiveFlag is not null);
                ...
                else
                {
                    ...
                    {
                        RoslynDebug.Assert(value.Discriminator != ConstantValueTypeDiscriminator.Bad);
            ...
            void incrementLoopControlVariable()
            {
                ...
                else
                {
                    ...
                    if (isNullable)
                    {
                        ...
                        RoslynDebug.Assert(controlVariableReferenceForAssignment.Kind == OperationKind.FlowCaptureReference);
                    ...
                    if (isNullable)
                    {
                        RoslynDebug.Assert(ITypeSymbolHelpers.IsNullableType(controlVariableReferenceForIncrement.Type));
                    ...
                    if (isNullable)
                    {
                        RoslynDebug.Assert(controlVariableReferenceForAssignment.Type != null);
            ...
            IOperation visitLoopControlVariableReference(bool forceImplicit)
            {
                switch (operation.LoopControlVariable.Kind)
                {
                    ...
                    default:
                        RoslynDebug.Assert(!_forceImplicit);
        ...
        public override IOperation? VisitSwitch(ISwitchOperation operation, int? captureIdForResult)
        {
            ...
            RoslynDebug.Assert(_currentRegion == switchRegion);
            if (defaultBody != null)
            {
            ...
            void handleSection(ISwitchCaseOperation section)
            {
                ...
                if (condition != null)
                {
                    RoslynDebug.Assert(section.Clauses.All(c => c.Label == null));
                    RoslynDebug.Assert(_currentSwitchOperationExpression == null);
        ...
        {
            RoslynDebug.Assert(ITypeSymbolHelpers.IsNullableType(type));
            RoslynDebug.Assert(ITypeSymbolHelpers.GetNullableUnderlyingType(type).Equals(operand.Type));
        ...
        private void HandleVariableDeclarator(IVariableDeclarationOperation declaration, IVariableDeclaratorOperation declarator)
        {
            ...
            RoslynDebug.Assert(initializer != null && assignmentSyntax != null);
            ...
            RoslynDebug.Assert((afterInitialization, localSymbol.IsStatic) is (null, false) or (not null, true));
            ...
            void handleInitializer(IOperation innerInitializer)
            {
                switch (innerInitializer.Kind)
                {
                    ...
                    default:
                        ...
                        RoslynDebug.Assert(validKinds.Contains(innerInitializer.Kind));
#endif
                        EvalStackFrame frame = PushStackFrame();
            ...
            bool tryPushTarget(IOperation instance)
            {
                switch (instance.Kind)
                {
                    ...
                    default:
                        ...
                        // assert.
                        RoslynDebug.Assert(instance.Kind == OperationKind.Invalid || instance.Kind == OperationKind.None);
                        return false;
                }
            }
        ...
        public override IOperation VisitAnonymousObjectCreation(IAnonymousObjectCreationOperation operation, int? captureIdForResult)
        {
            ...
            RoslynDebug.Assert(_currentImplicitInstance.AnonymousTypePropertyValues is not null);
            ...
            for (int i = 0; i < operation.Initializers.Length; i++)
            {
                ...
                RoslynDebug.Assert(propertyReference.Arguments.IsEmpty);
                RoslynDebug.Assert(propertyReference.Instance != null);
                RoslynDebug.Assert(propertyReference.Instance.Kind == OperationKind.InstanceReference);
                RoslynDebug.Assert(((IInstanceReferenceOperation)propertyReference.Instance).ReferenceKind == InstanceReferenceKind.ImplicitReceiver);
        ...
        public override IOperation? VisitLocalFunction(ILocalFunctionOperation operation, int? captureIdForResult)
        {
            ...
            {
                RoslynDebug.Assert(owner.Enclosing != null);
        ...
        {
            RoslynDebug.Assert(_currentStatement == null);
        ...
        public override IOperation VisitInstanceReference(IInstanceReferenceOperation operation, int? captureIdForResult)
        {
            if (operation.ReferenceKind == InstanceReferenceKind.ImplicitReceiver)
            {
                ...
                RoslynDebug.Assert(operation.IsImplicit);
        ...
        {
            RoslynDebug.Assert(left != null);
            RoslynDebug.Assert(right != null);
        ...
        public override IOperation VisitInterpolatedString(IInterpolatedStringOperation operation, int? captureIdForResult)
        {
            ...
            for (int i = operation.Parts.Length - 1; i >= 0; i--)
            {
                ...
                if (element.Kind == OperationKind.Interpolation)
                {
                    ...
                    {
                        RoslynDebug.Assert(interpolation.FormatString.Kind == OperationKind.Literal);
                ...
                else
                {
                    ...
                    RoslynDebug.Assert(interpolatedStringText.Text.Kind == OperationKind.Literal);
        ...
        {
            RoslynDebug.Assert(operation.GetConstantValue() != null);
        ...
        public override IOperation VisitEventAssignment(IEventAssignmentOperation operation, int? captureIdForResult)
        {
            ...
            {
                RoslynDebug.Assert(operation.EventReference != null);
        ...
        public override IOperation VisitInvalid(IInvalidOperation operation, int? captureIdForResult)
        {
            ...
            {
                RoslynDebug.Assert(_currentStatement == invalidOperation);
        ...
        public IOperation? Visit(IOperation? operation)
        {
            ...
            RoslynDebug.Assert(operation == null || ((Operation)operation).OwningSemanticModel!.Compilation == _compilation);
        ...
        public IOperation? VisitRequired(IOperation? operation, int? argument = null)
        {
            ...
            RoslynDebug.Assert((result == null) == (operation == null));
            return result;
        }
