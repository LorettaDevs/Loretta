...
#pragma warning restore
            ...
            {
                RoslynDebug.Assert(Region != null);
            ...
            public bool HasPredecessors
            {
                get
                {
                    ...
                    {
                        RoslynDebug.Assert(_predecessor1 == null);
                        RoslynDebug.Assert(_predecessor2 == null);
            ...
            public bool HasCondition
            {
                get
                {
                    ...
                    RoslynDebug.Assert(!result || BranchValue != null);
                    return result;
                }
            }
            ...
            {
                RoslynDebug.Assert(predecessor != null);
                ...
                else
                {
                    ...
                    _predecessors.Add(predecessor);
                    RoslynDebug.Assert(_predecessors.Count == 3);
                    _predecessor1 = null;
                    _predecessor2 = null;
                }
            }
            ...
            public ImmutableArray<ControlFlowBranch> ConvertPredecessorsToBranches(ArrayBuilder<BasicBlock> blocks)
            {
                ...
                void addBranches(BasicBlockBuilder predecessorBlockBuilder)
                {
                    ...
                    RoslynDebug.Assert(predecessor.FallThroughSuccessor != null);
