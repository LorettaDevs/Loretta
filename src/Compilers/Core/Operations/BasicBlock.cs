...
namespace Loretta.CodeAnalysis.FlowAnalysis
{
    ...
    public sealed class BasicBlock
    {
        ...
        public ControlFlowBranch? FallThroughSuccessor
        {
            ...
            {
#if DEBUG
                RoslynDebug.Assert(_successorsAreSealed);
#endif
        ...
        public ImmutableArray<ControlFlowBranch> Predecessors
        {
            ...
            {
#if DEBUG
                RoslynDebug.Assert(_predecessorsAreSealed);
#endif
...
#if DEBUG
            RoslynDebug.Assert(!_successorsAreSealed);
            RoslynDebug.Assert(_lazySuccessor == null);
            RoslynDebug.Assert(_lazyConditionalSuccessor == null);
#endif
...
#if DEBUG
            RoslynDebug.Assert(!_predecessorsAreSealed);
            RoslynDebug.Assert(_lazyPredecessors.IsDefault);
            RoslynDebug.Assert(!predecessors.IsDefault);
#endif
