...
namespace Loretta.CodeAnalysis.FlowAnalysis
{
    internal partial class ControlFlowGraphBuilder
    {
        ...
        private struct ImplicitInstanceInfo
        {
            ...
            {
                RoslynDebug.Assert(currentImplicitInstance != null);
            ...
            {
                RoslynDebug.Assert(currentInitializedAnonymousType.IsAnonymousType);
            ...
            {
                RoslynDebug.Assert(context.ImplicitInstance == null || context.AnonymousType == null);
