...
namespace Loretta.CodeAnalysis.Diagnostics
{
    ...
    internal class AnalysisScope
    {
        ...
        {
            RoslynDebug.Assert(isPartialAnalysis || FilterFileOpt == null);
            RoslynDebug.Assert(isPartialAnalysis || FilterSpanOpt == null);
            RoslynDebug.Assert(isPartialAnalysis || !isSyntacticSingleFileAnalysis);
        ...
        public bool Contains(DiagnosticAnalyzer analyzer)
        {
            ...
            {
                RoslynDebug.Assert(_lazyAnalyzersSet.Value.Contains(analyzer));
                return true;
            }
