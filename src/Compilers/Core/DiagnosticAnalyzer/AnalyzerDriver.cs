...
using Loretta.CodeAnalysis.Diagnostics.Telemetry;
...
namespace Loretta.CodeAnalysis.Diagnostics
{
    ...
    internal abstract partial class AnalyzerDriver : IDisposable
    {
        ...
        protected AnalyzerExecutor AnalyzerExecutor
        {
            get
            {
                RoslynDebug.Assert(_lazyAnalyzerExecutor != null);
        ...
        protected CompilationData CurrentCompilationData
        {
            get
            {
                RoslynDebug.Assert(_lazyCurrentCompilationData != null);
        ...
        protected ImmutableHashSet<DiagnosticAnalyzer> UnsuppressedAnalyzers
        {
            get
            {
                RoslynDebug.Assert(_lazyUnsuppressedAnalyzers != null);
        ...
        private ConcurrentDictionary<(INamespaceOrTypeSymbol, DiagnosticAnalyzer), IGroupedAnalyzerActions> PerSymbolAnalyzerActionsCache
        {
            get
            {
                RoslynDebug.Assert(_lazyPerSymbolAnalyzerActionsCache != null);
        ...
        private ImmutableHashSet<DiagnosticAnalyzer> CompilationEndAnalyzers
        {
            get
            {
                RoslynDebug.Assert(_lazyCompilationEndAnalyzers != null);
        ...
        private ImmutableDictionary<DiagnosticAnalyzer, SemaphoreSlim> AnalyzerGateMap
        {
            get
            {
                RoslynDebug.Assert(_lazyAnalyzerGateMap != null);
        ...
        private ImmutableDictionary<DiagnosticAnalyzer, GeneratedCodeAnalysisFlags> GeneratedCodeAnalysisFlagsMap
        {
            get
            {
                RoslynDebug.Assert(_lazyGeneratedCodeAnalysisFlagsMap != null);
        ...
        private ImmutableHashSet<DiagnosticAnalyzer> NonConfigurableAnalyzers
        {
            get
            {
                RoslynDebug.Assert(_lazyNonConfigurableAnalyzers != null);
        ...
        private ImmutableHashSet<DiagnosticAnalyzer> SymbolStartAnalyzers
        {
            get
            {
                RoslynDebug.Assert(_lazySymbolStartAnalyzers != null);
        ...
        private bool TreatAllCodeAsNonGeneratedCode
        {
            get
            {
                RoslynDebug.Assert(_lazyTreatAllCodeAsNonGeneratedCode.HasValue);
        ...
        private ConcurrentDictionary<SyntaxTree, bool> GeneratedCodeFilesMap
        {
            get
            {
                RoslynDebug.Assert(_lazyGeneratedCodeFilesMap != null);
        ...
        private Dictionary<SyntaxTree, ImmutableHashSet<ISymbol>> GeneratedCodeSymbolsForTreeMap
        {
            get
            {
                RoslynDebug.Assert(_lazyGeneratedCodeSymbolsForTreeMap != null);
        ...
        private ConcurrentDictionary<SyntaxTree, ImmutableHashSet<DiagnosticAnalyzer>> SuppressedAnalyzersForTreeMap
        {
            get
            {
                RoslynDebug.Assert(_lazySuppressedAnalyzersForTreeMap != null);
        ...
        private ConcurrentDictionary<ISymbol, bool> IsGeneratedCodeSymbolMap
        {
            get
            {
                RoslynDebug.Assert(_lazyIsGeneratedCodeSymbolMap != null);
        ...
        public AsyncQueue<CompilationEvent> CompilationEventQueue
        {
            get
            {
                RoslynDebug.Assert(_lazyCompilationEventQueue != null);
        ...
        public DiagnosticQueue DiagnosticQueue
        {
            get
            {
                RoslynDebug.Assert(_lazyDiagnosticQueue != null);
        ...
        {
            RoslynDebug.Assert(!severityFilter.Contains(ReportDiagnostic.Suppress));
            RoslynDebug.Assert(!severityFilter.Contains(ReportDiagnostic.Default));
        ...
        private void Initialize(AnalyzerExecutor analyzerExecutor, DiagnosticQueue diagnosticQueue, CompilationData compilationData, CancellationToken cancellationToken)
        {
            try
            {
                RoslynDebug.Assert(_lazyInitializeTask == null);
        ...
        {
            RoslynDebug.Assert(_lazyInitializeTask == null);
            RoslynDebug.Assert(compilation.SemanticModelProvider != null);
        ...
        {
            RoslynDebug.Assert(analysisScope != null);
        ...
        {
            RoslynDebug.Assert(faultedTask.IsFaulted);
        ...
        {
            RoslynDebug.Assert(!reportedDiagnostics.IsEmptyWithoutResolution);
        ...
        {
            RoslynDebug.Assert(_hasDiagnosticSuppressors);
            RoslynDebug.Assert(!reportedDiagnostics.IsEmpty);
            RoslynDebug.Assert(_programmaticSuppressions != null);
            RoslynDebug.Assert(_diagnosticsProcessedForProgrammaticSuppressions != null);
            ...
            try
            {
                ...
                foreach (var diagnostic in reportedDiagnostics)
                {
                    ...
                    {
                        RoslynDebug.Assert(suppressableDiagnostics.Contains(diagnostic));
                        RoslynDebug.Assert(!diagnostic.IsSuppressed);
                        var suppressedDiagnostic = diagnostic.WithProgrammaticSuppression(programmaticSuppressionInfo);
                        RoslynDebug.Assert(suppressedDiagnostic.IsSuppressed);
        ...
        private bool IsInGeneratedCode(Location location, Compilation compilation, CancellationToken cancellationToken)
        {
            ...
            if (_lazyGeneratedCodeAttribute != null)
            {
                ...
                if (generatedCodeSymbolsInTree.Count > 0)
                {
                        ...
                        node = node.Parent)
                    {
                        ...
                        RoslynDebug.Assert(declaredSymbols != null);
            ...
            {
                RoslynDebug.Assert(GeneratedCodeSymbolsForTreeMap != null);
                RoslynDebug.Assert(_lazyGeneratedCodeAttribute != null);
                ...
                lock (GeneratedCodeSymbolsForTreeMap)
                {
                    ...
                    {
                        RoslynDebug.Assert(existingGeneratedCodeSymbols.SetEquals(generatedCodeSymbols));
                    }
                }
        ...
        public Task WhenCompletedTask
        {
            get
            {
                RoslynDebug.Assert(_lazyPrimaryTask != null);
                    ...
                    if (!CompilationEventQueue.TryDequeue(out var compilationEvent))
                    {
                        if (!prePopulatedEventQueue)
                        {
                            ...
                            if (!optionalEvent.HasValue)
                            {
                                ...
                                RoslynDebug.Assert(CompilationEventQueue.IsCompleted, "TryDequeueAsync should provide a value unless the AsyncQueue<T> is completed.");
                                break;
                            }
        ...
        private async ValueTask<EventProcessedState> TryProcessSymbolDeclaredAsync(SymbolDeclaredCompilationEvent symbolEvent, AnalysisScope analysisScope, AnalysisState? analysisState, CancellationToken cancellationToken)
        {
            ...
            {
                RoslynDebug.Assert(!subsetProcessedAnalyzers.IsDefault);
        ...
        {
            RoslynDebug.Assert(AnalyzerActions.SymbolStartActionsCount > 0);
            ...
            try
            {
                ...
                if (!success)
                {
                    RoslynDebug.Assert(completedAnalyzers.Count < analysisScope.Analyzers.Length);
        ...
        private bool TryExecuteCompilationActions(
            ...
            AnalysisState? analysisState)
        {
            RoslynDebug.Assert(compilationEvent is CompilationStartedEvent || compilationEvent is CompilationCompletedEvent);
        ...
        {
            RoslynDebug.Assert(AnalyzerActions.SymbolStartActionsCount > 0);
            RoslynDebug.Assert(SymbolStartAnalyzers.Contains(analyzer));
            ...
            SeverityFilter severityFilter)
        {
            ...
            foreach (var analyzer in analyzers)
            {
                RoslynDebug.Assert(!IsDiagnosticAnalyzerSuppressed(analyzer, analyzerExecutor.Compilation.Options, analyzerManager, analyzerExecutor, severityFilter));
        ...
        protected bool DoNotAnalyzeGeneratedCode
        {
            get
            {
                RoslynDebug.Assert(_lazyDoNotAnalyzeGeneratedCode.HasValue);
    ...
    internal partial class AnalyzerDriver<TLanguageKindEnum> : AnalyzerDriver where TLanguageKindEnum : struct
    {
        ...
        {
            RoslynDebug.Assert(analysisState != null);
        ...
        private bool TryExecuteDeclaringReferenceActions(
            ...
            CancellationToken cancellationToken)
        {
            RoslynDebug.Assert(shouldExecuteSyntaxNodeActions || shouldExecuteOperationActions || shouldExecuteCodeBlockActions || shouldExecuteOperationBlockActions);
            RoslynDebug.Assert(!isInGeneratedCode || !DoNotAnalyzeGeneratedCode);
            ...
            ImmutableArray<IOperation> operationBlocks)
        {
                    ...
                    if (operationBlock.Parent != null)
                    {
                        switch (operationBlock.Parent.Kind)
                        {
                            ...
                            case OperationKind.ConstructorBody:
                                RoslynDebug.Assert(!operationBlock.Parent.IsImplicit);
                            ...
                            case OperationKind.ExpressionStatement:
                                ...
                                RoslynDebug.Assert(operationBlock.Kind == OperationKind.Invocation);
                                RoslynDebug.Assert(operationBlock.Parent.IsImplicit);
                                RoslynDebug.Assert(operationBlock.Parent.Parent is IConstructorBodyOperation ctorBody &&
                                    ctorBody.Initializer == operationBlock.Parent);
                                RoslynDebug.Assert(!operationBlock.Parent.Parent.IsImplicit);
            ...
            RoslynDebug.Assert(operationsToAnalyze.ToImmutableHashSet().Count == operationsToAnalyze.Count);
