...
using Loretta.CodeAnalysis.FlowAnalysis;
using Loretta.CodeAnalysis.Operations;
using Loretta.CodeAnalysis.PooledObjects;
using Loretta.CodeAnalysis.Text;
using Loretta.Utilities;

using AnalyzerStateData = Loretta.CodeAnalysis.Diagnostics.AnalysisState.AnalyzerStateData;
using DeclarationAnalyzerStateData = Loretta.CodeAnalysis.Diagnostics.AnalysisState.DeclarationAnalyzerStateData;
using OperationAnalyzerStateData = Loretta.CodeAnalysis.Diagnostics.AnalysisState.OperationAnalyzerStateData;
using SyntaxNodeAnalyzerStateData = Loretta.CodeAnalysis.Diagnostics.AnalysisState.SyntaxNodeAnalyzerStateData;
...
namespace Loretta.CodeAnalysis.Diagnostics
{
    ...
    internal partial class AnalyzerExecutor
    {
        ...
        {
            RoslynDebug.Assert(_isAnalyzerSuppressedForTree != null);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            RoslynDebug.Assert((addNonCategorizedDiagnostic != null) ^ (addCategorizedLocalDiagnostic != null));
            RoslynDebug.Assert((addCategorizedLocalDiagnostic != null) == (addCategorizedNonLocalDiagnostic != null));
        ...
        internal Compilation Compilation
        {
            get
            {
                RoslynDebug.Assert(_compilation != null);
                return _compilation;
            }
        }
        ...
        internal AnalyzerOptions AnalyzerOptions
        {
            get
            {
                RoslynDebug.Assert(_analyzerOptions != null);
        ...
        internal ImmutableDictionary<DiagnosticAnalyzer, TimeSpan> AnalyzerExecutionTimes
        {
            get
            {
                RoslynDebug.Assert(_analyzerExecutionTimeMap != null);
            ...
            HostSymbolStartAnalysisScope symbolScope)
        {
            ...
            foreach (var startAction in actions)
            {
                RoslynDebug.Assert(startAction.Analyzer == analyzer);
                _cancellationToken.ThrowIfCancellationRequested();
        ...
        {
            RoslynDebug.Assert(_addSuppression != null);
            RoslynDebug.Assert(_getSemanticModel != null);
        ...
        private void ExecuteSymbolActionsCore(
            ...
            bool isGeneratedCodeSymbol)
        {
            RoslynDebug.Assert(getTopMostNodeForAnalysis != null);
        ...
        {
            RoslynDebug.Assert(getTopMostNodeForAnalysis != null);
            RoslynDebug.Assert(!IsAnalyzerSuppressedForSymbol(analyzer, symbolDeclaredEvent.Symbol));
        ...
        {
            RoslynDebug.Assert(analyzerState == null || analyzerState.CurrentNode == node);
            RoslynDebug.Assert(!IsAnalyzerSuppressedForTree(syntaxNodeAction.Analyzer, node.SyntaxTree));
        ...
        {
            RoslynDebug.Assert(analyzerState == null || analyzerState.CurrentOperation == operation);
            RoslynDebug.Assert(!IsAnalyzerSuppressedForTree(operationAction.Analyzer, semanticModel.SyntaxTree));
        ...
        {
            RoslynDebug.Assert(declaredNode != null);
            RoslynDebug.Assert(declaredSymbol != null);
            RoslynDebug.Assert(CanHaveExecutableCodeBlock(declaredSymbol));
            RoslynDebug.Assert(startActions.Any() || endActions.Any() || actions.Any());
            RoslynDebug.Assert(!executableBlocks.IsEmpty);
            ...
            if (executableNodeActions.Any())
            {
                ...
                {
                    RoslynDebug.Assert(getKind != null);
        ...
        private void ExecuteBlockActions<TBlockAction, TNodeStateData>(
            ...
            where TNodeStateData : AnalyzerStateData, new()
        {
            RoslynDebug.Assert(!IsAnalyzerSuppressedForTree(analyzer, declaredNode.SyntaxTree));
        ...
        internal static ImmutableDictionary<TLanguageKindEnum, ImmutableArray<SyntaxNodeAnalyzerAction<TLanguageKindEnum>>> GetNodeActionsByKind<TLanguageKindEnum>(
            ...
            where TLanguageKindEnum : struct
        {
            RoslynDebug.Assert(nodeActions != null && nodeActions.Any());
        ...
        private void ExecuteSyntaxNodeActions<TLanguageKindEnum>(
            ...
            where TLanguageKindEnum : struct
        {
            RoslynDebug.Assert(nodeActionsByKind.Any());
            RoslynDebug.Assert(!IsAnalyzerSuppressedForTree(analyzer, model.SyntaxTree));
        ...
        {
            RoslynDebug.Assert(operationActions.Any());
        ...
        private void ExecuteOperationActions(
            ...
            OperationAnalyzerStateData? analyzerState)
        {
            RoslynDebug.Assert(operationActionsByKind != null);
            RoslynDebug.Assert(operationActionsByKind.Any());
            RoslynDebug.Assert(!IsAnalyzerSuppressedForTree(analyzer, model.SyntaxTree));
        ...
        internal static bool CanHaveExecutableCodeBlock(ISymbol symbol)
        {
            switch (symbol.Kind)
            {
                ...
                case SymbolKind.Field:
                    RoslynDebug.Assert(((IFieldSymbol)symbol).AssociatedSymbol == null);
                    return true;
        ...
        internal static bool AreEquivalentAnalyzerExceptionDiagnostics(Diagnostic exceptionDiagnostic, Diagnostic other)
        {
            ...
            RoslynDebug.Assert(IsAnalyzerExceptionDiagnostic(exceptionDiagnostic));
        ...
        {
            RoslynDebug.Assert(_isCompilerAnalyzer != null);
            ...
            CancellationToken cancellationToken)
        {
            return diagnostic =>
            {
                ...
                {
                    RoslynDebug.Assert(addNonCategorizedDiagnostic != null);
                    addNonCategorizedDiagnostic(diagnostic);
                    return;
                }

                RoslynDebug.Assert(addNonCategorizedDiagnostic == null);
                RoslynDebug.Assert(addCategorizedNonLocalDiagnostic != null);
        ...
        private Action<Diagnostic> GetAddCompilationDiagnostic(DiagnosticAnalyzer analyzer)
        {
            return diagnostic =>
            {
                ...
                {
                    RoslynDebug.Assert(_addNonCategorizedDiagnostic != null);
        ...
        {
            RoslynDebug.Assert(nonSymbolCompilationEvent is not SymbolDeclaredCompilationEvent);
            RoslynDebug.Assert(analysisScope.Contains(analyzer));
