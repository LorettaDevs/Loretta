...
namespace Loretta.CodeAnalysis.Diagnostics
{
    ...
    internal sealed class AnalysisResultBuilder
    {
        ...
        {
            RoslynDebug.Assert(_analyzerExecutionTimeOpt != null);
        ...
        {
            RoslynDebug.Assert(!fullAnalysisResultForAnalyzersInScope || analysisScope.FilterFileOpt == null, "Full analysis result cannot come from partial (tree) analysis.");
        ...
        {
            RoslynDebug.Assert(getLocalDiagnostics || getNonLocalDiagnostics);
