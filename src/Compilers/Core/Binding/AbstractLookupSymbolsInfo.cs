        ...
        where TSymbol : class, ISymbolInternal
    {
        ...
        private struct UniqueSymbolOrArities : IArityEnumerable
        {
            ...
            public UniqueSymbolOrArities(int arity, TSymbol uniqueSymbol)
            {
                ...
                RoslynDebug.Assert((uniqueSymbol != null) || (arity == 0));
            }
            ...
            public void AddSymbol(TSymbol symbol, int arity)
            {
                ...
                {
                    RoslynDebug.Assert(arity == _arityBitVectorOrUniqueArity);
                    return;
                }
                ...
                if (this.HasUniqueSymbol)
                {
                    ...
                    RoslynDebug.Assert(_uniqueSymbolOrArities is TSymbol);
            ...
            {
                RoslynDebug.Assert(!this.HasUniqueSymbol);
...
#nullable enable
        ...
        public void AddSymbol(TSymbol symbol, string name, int arity)
        {
            ...
            // horribly wrong.
            RoslynDebug.Assert(pair.UniqueSymbol == null || pair.UniqueSymbol == symbol);
#endif
        }
        ...
        {
            RoslynDebug.Assert(CanBeAdded(name));
