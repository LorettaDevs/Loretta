...
namespace Loretta.CodeAnalysis
{
    ...
    internal static class WellKnownTypes
    {
        ...
        private static readonly string[] s_metadataNames = new string[]
        {
            ...
            "Loretta.CodeAnalysis.Runtime.Instrumentation",
            ...
            "Loretta.CodeAnalysis.EmbeddedAttribute",
        ...
        private static void AssertEnumAndTableInSync()
        {
            for (int i = 0; i < s_metadataNames.Length; i++)
            {
                ...
                RoslynDebug.Assert(name == typeIdName, "Enum name and type name must match");
            }

            RoslynDebug.Assert((int)WellKnownType.ExtSentinel == 255);
            RoslynDebug.Assert((int)WellKnownType.NextAvailable <= 512, "Time for a new sentinel");
        }

        public static bool IsWellKnownType(this WellKnownType typeId)
        {
            RoslynDebug.Assert(typeId != WellKnownType.ExtSentinel);
        ...
        public static WellKnownType GetTypeFromMetadataName(string metadataName)
        {
            ...
            RoslynDebug.Assert(WellKnownType.First != 0);
        ...
        {
            RoslynDebug.Assert(invokeArgumentCount >= 0);
