...
namespace Loretta.DiaSymReader
{
    ...
    internal sealed unsafe class SymWriterMetadataAdapter : MetadataAdapterBase
    {
        ...
        {
            RoslynDebug.Assert(metadataProvider != null);
        ...
        public override int GetTypeDefProps(
            ...
            [Out] int* baseType)
        {
            RoslynDebug.Assert(baseType == null);
        ...
        {
            RoslynDebug.Assert(attributes == null);
            RoslynDebug.Assert(signature == null);
            RoslynDebug.Assert(signatureLength == null);
            RoslynDebug.Assert(relativeVirtualAddress == null);
            RoslynDebug.Assert(implAttributes == null);
