...
namespace Loretta.DiaSymReader
{
    internal static class SymUnmanagedFactory
    {
        ...
        private const string DiaSymReaderModuleName32 = "Loretta.DiaSymReader.Native.x86.dll";
        private const string DiaSymReaderModuleName64 = "Loretta.DiaSymReader.Native.amd64.dll";
