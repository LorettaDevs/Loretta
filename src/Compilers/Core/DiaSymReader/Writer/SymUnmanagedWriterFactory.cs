...
namespace Loretta.DiaSymReader
{
    internal static class SymUnmanagedWriterFactory
    {
        ...
        /// <remarks>
        /// Tries to load the implementation of the PDB writer from Loretta.DiaSymReader.Native.{platform}.dll library first.
        /// It searches for this library in the directory Loretta.DiaSymReader.dll is loaded from, 
        ...
        /// If the Loretta.DiaSymReader.Native.{platform}.dll library can't be found and <see cref="SymUnmanagedWriterCreationOptions.UseComRegistry"/> 
            ...
            SymUnmanagedWriterCreationOptions options = SymUnmanagedWriterCreationOptions.Default)
        {
            ...
            if (symWriter == null)
            {
                RoslynDebug.Assert(loadException != null);
