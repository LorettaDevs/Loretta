...
namespace Loretta.CodeAnalysis
{
    internal class RelativePathResolver : IEquatable<RelativePathResolver>
    {
        ...
        {
            RoslynDebug.Assert(searchPaths.All(PathUtilities.IsAbsolute));
            RoslynDebug.Assert(baseDirectory == null || PathUtilities.GetPathKind(baseDirectory) == PathKind.Absolute);
