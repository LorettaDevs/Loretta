...
- Added new node `FunctionTypeParameterSyntax` that represents a parameter to a function type/signature by @GGG-KILLER in https://github.com/LorettaDevs/Loretta/pull/145.
